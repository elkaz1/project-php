...
<header class='flex shadow-md py-4 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[70px] tracking-wide relative z-50'>
  <div class='flex flex-wrap items-center justify-between gap-5 w-full'>
    <a href="javascript:void(0)"><img src="../assets/logo.png" alt="logo" class='w-20' />
    </a>
    ...
    <div id="collapseMenu"
      ...
      <ul
        ...
        <li class='mb-6 hidden max-lg:block'>
          <a href="index.php"><img src="https://readymadeui.com/readymadeui.svg" alt="logo" class='w-36' />
          </a>
        </li>
        <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
          <a href='index.php'
            class='hover:text-[#000] text-gray-500 block font-semibold text-[15px]'>Home</a>
        </li>
        <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><a href='prediction.php'
            class='hover:text-[#000] text-gray-500 block font-semibold text-[15px]'>Prediction</a>
        </li>
        <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><a href='aboutus.php'
            class='hover:text-[#000] text-gray-500 block font-semibold text-[15px]'>About Us</a>
        </li>
        <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><a href='contact.php'
            class='hover:text-[#000] text-gray-500 block font-semibold text-[15px]'>Contact Us</a>
        </li>
      </ul>
    </div>
